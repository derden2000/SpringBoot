...
create table orders (id bigserial, user_id bigint, price numeric(8, 2), address text, primary key(id), constraint fk_user_id foreign key (user_id) references users (id));
